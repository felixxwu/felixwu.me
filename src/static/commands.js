...
const commands = {
    ...
    work: () => {
        store.dispatch("pushBlock", parse(
            ...
            $b VIOLA DA GAMBA SOCIETY WEBSITE REDESIGN (Freelance, 2016)
            ...
            $b ROOM ACOUSTICS SIMULATION (Placement, 2015)
            ...
            $b SPACEX HYPERLOOP STUDENT COMPETITION (2016 / 17)
            ...
            $b PARENTS' EVENING MODELLING AND PROPOSAL (2016)
