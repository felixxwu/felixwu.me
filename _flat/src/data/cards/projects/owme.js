export default {
  ...
  <br>
  Both FlatApp and Owme were used extensively by my flatmates and I during the first and second years of University, to manage debts from bills and groceries.

  Feature overview:
  <ul>
    <li>A clean and dynamic, single-page design</li>
    <li>Google sign-in</li>
    <li>Easily manage your friends and groups</li>
    <li>Create debts with one or more friends, or a whole group</li>
    <li>If there are any circles of debt, they are automatically settled up</li>
